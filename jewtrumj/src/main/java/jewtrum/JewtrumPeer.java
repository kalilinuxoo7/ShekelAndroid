...
import jewtrum.messages.BaseMsg;
import jewtrum.messages.GetBalanceMsg;
import jewtrum.messages.GetHeader;
import jewtrum.messages.GetHistoryMsg;
import jewtrum.messages.GetTxMsg;
import jewtrum.messages.ListUnspentMsg;
import jewtrum.messages.Method;
import jewtrum.messages.SubscribeAddressMsg;
...
public class JewtrumPeer implements IoHandler{

    private final Logger log;

    /** Peer data */
    private JewtrumPeerData peerData;
    /**  */
    ...
    public JewtrumPeer(JewtrumPeerData peerData,IoManager ioManager,VersionMsg versionMsg) {
        this.peerData = peerData;
        this.ioManager = ioManager;
        this.versionMsg = versionMsg;
        this.log = LoggerFactory.getLogger(JewtrumPeer.class.getName()+"-"+peerData.getHost());
    }
    ...
    public void connect() throws ConnectionFailureException, InterruptedException {
        if (isInitilizing.compareAndSet(false,true) && !isRunning.get()) {
            ...
            throw new IllegalStateException("JewtrumPeer already initializing");
        }
    }
    ...
    public JewtrumPeerData getPeerData() {
        return peerData;
    }

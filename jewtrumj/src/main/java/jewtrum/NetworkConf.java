...
public class NetworkConf {
    ...
    private JewtrumPeerData trustedHost;
    ...
    public JewtrumPeerData getTrustedServer() {
        return trustedHost;
    }

    public void setTrustedServer(JewtrumPeerData jewtrumPeerData) {
        this.trustedHost = jewtrumPeerData;

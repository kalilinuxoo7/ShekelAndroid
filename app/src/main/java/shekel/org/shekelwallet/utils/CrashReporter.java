...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final ShekelApplication application) throws IOException {
		...
		report.append("Test/Prod: " + (ShekelContext.IS_TEST ? "test" : "prod") + "\n");
		...
		report.append("Network: " + ShekelContext.NETWORK_PARAMETERS.getId() + "\n");

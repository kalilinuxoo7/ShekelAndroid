package shekel.org.shekelwallet.ui.settings_activity;
...
import shekel.org.shekelwallet.BuildConfig;
...
import shekel.org.shekelwallet.ui.export_account.ExportKeyActivity;
import shekel.org.shekelwallet.ui.import_watch_only.SettingsWatchOnly;
import shekel.org.shekelwallet.ui.restore_activity.RestoreActivity;
import shekel.org.shekelwallet.ui.settings_backup_activity.SettingsBackupActivity;
import shekel.org.shekelwallet.ui.settings_network_activity.SettingsNetworkActivity;
import shekel.org.shekelwallet.ui.settings_pincode_activity.SettingsPincodeActivity;
import shekel.org.shekelwallet.ui.start_node_activity.StartNodeActivity;
import shekel.org.shekelwallet.ui.tutorial_activity.TutorialActivity;
import shekel.org.shekelwallet.utils.CrashReporter;
import shekel.org.shekelwallet.utils.DialogsUtil;
import shekel.org.shekelwallet.utils.IntentsUtils;
import shekel.org.shekelwallet.utils.NavigationUtils;
import shekel.org.shekelwallet.utils.ReportIssueDialogBuilder;
...
import static shekel.org.shekelwallet.ui.tutorial_activity.TutorialActivity.INTENT_EXTRA_INFO_TUTORIAL;
...
public class SettingsActivity extends BaseDrawerActivity implements View.OnClickListener {
    ...
    protected void onCreateView(Bundle savedInstanceState, ViewGroup container) {
        ...
        String text = "Made by<br> <font color=#b4ba06>Crypto-Dev(Kaali)</font> <br>(c) SHEKEL Community";
    ...
    private void updateNetworkStatus() {
        txt_network_info.setText(
                Html.fromHtml(
                        "Network<br><font color=#b4ba06>"+shekelModule.getConf().getNetworkParams().getId()+
                                "</font><br>" +
                                "Height<br><font color=#b4ba06>"+shekelModule.getChainHeight()+"</font><br>" +
                                "Protocol Version<br><font color=#b4ba06>"+
                                shekelModule.getProtocolVersion()+"</font>"
    ...
    private void launchReportDialog() {
        ReportIssueDialogBuilder dialog = new ReportIssueDialogBuilder(
                this,
                "shekel.org.shekelwallet.myfileprovider",
                ...
                R.string.report_issue_dialog_message_issue)
        {
            ...
            protected CharSequence subject() {
                return ShekelContext.REPORT_SUBJECT_ISSUE+" "+shekelApplication.getVersionName();
            }
            ...
            protected CharSequence collectApplicationInfo() throws IOException {
                ...
                CrashReporter.appendApplicationInfo(applicationInfo, shekelApplication);
            ...
            protected CharSequence collectWalletDump() throws IOException {
                return shekelModule.getWallet().toString(false,true,true,null);
            }
        };
        dialog.show();
    }

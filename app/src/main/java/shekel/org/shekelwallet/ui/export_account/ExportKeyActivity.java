package shekel.org.shekelwallet.ui.export_account;
...
import shekel.org.shekelwallet.utils.AndroidUtils;
...
public class ExportKeyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initValues() throws WriterException {
        DeterministicKey deterministicKey = shekelModule.getWatchingKey();
        xpubKey = deterministicKey.serializePubB58(ShekelContext.NETWORK_PARAMETERS);

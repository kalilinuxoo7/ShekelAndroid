package shekel.org.shekelwallet.ui.settings_backup_activity;
...
public class SettingsBackupActivity extends BaseActivity {
    ...
    private void backup() {
        ...
        try {
            ...
            boolean result = shekelModule.backupWallet(backupFile, firstPassword);

            if (result){
                shekelApplication.getAppConf().setHasBackup(true);

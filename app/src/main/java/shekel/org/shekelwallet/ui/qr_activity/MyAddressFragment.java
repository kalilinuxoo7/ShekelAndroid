package shekel.org.shekelwallet.ui.qr_activity;
...
import static shekel.org.shekelwallet.utils.AndroidUtils.copyToClipboard;
import static shekel.org.shekelwallet.utils.QrUtils.encodeAsBitmap;
...
public class MyAddressFragment extends Fragment implements View.OnClickListener {
    ...
    public static MyAddressFragment newInstance(ShekelModule shekelModule) {
        MyAddressFragment f = new MyAddressFragment();
        f.setModule(shekelModule);
        return f;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        module = ShekelApplication.getInstance().getModule();
    ...
    public void onResume() {
        ...
        try {
            ...
            if (flag) {
                String shekelUri = ShekelURI.convertToBitcoinURI(address,null,"Receive address",null);
                loadAddress(shekelUri,address.toBase58());
            }
    ...
    public void setModule(ShekelModule module) {
        this.module = module;
    }
